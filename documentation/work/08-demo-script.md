...
4. **Tie-back (CFO & CMO):** cost down and a verifiable carbon story.
...
5. **Tie-back (Quality Officer):** best-known methods, preserved and spread →
...
- **Tie-back (Compliance Manager):** auditable and compliant by design.
...
## Persona tie-back cheat sheet

| Scene | COO | CFO | Quality | CMO | Compliance |
| ----- | --- | --- | ------- | --- | ---------- |
| A Predict | ✅ uptime | ✅ avoided €8M | — | — | audit log |
| B Energy | reliability | ✅ −14% cost | — | ✅ −22% CO₂ | reporting integrity |
| C Knowledge | continuity | productivity | ✅ +8% yield | brand | GDPR/DPIA |
| Trust | observability | risk | traceability | trust | ✅ AI Act |
