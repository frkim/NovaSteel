...
(COO · CFO · Quality Officer · CMO · Compliance Manager).
...
### Slide 10 — Quality (for the Quality Officer)
...
### Slide 11 — Sustainability & brand (for the CMO)
...
### Slide 13 — Trust & compliance (for the Compliance Manager)
...
- **Per persona "so what":**
  ...
  - Quality: +8% yield, full traceability.
  - CMO: −22% CO₂ story.
  - Compliance: GDPR + AI Act, audit-ready.
- *Visual:* single CTA.
